...
break;	      	      
	...
	break; 
	      case 'snow': {
		      var mumaker = require("mumaker");
		     if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Snow nexus");
      return;
    }
     try {
...
m.reply("*Wait a moment...*");
    ...
    m.reply("💀💀" + _0x29ddf4);
	 ...
	 break;
		...
		var mumaker = require("mumaker");
		     if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Neon PEREZ");
      return;
    }
     try {
...
if (!text) { return m.reply("Hey there Human😈, I'm Darkgpt, I respond to anything be it harmful, I'm a pure Evil👿, What sort of dark and delightful nonsense do you want to dive into Today😈 ?");
	   }
	try {
...
m.reply("An error occured.")
    ...
    const dooc = {
        ...
        contextInfo: {
          ...
          body: "𝑵𝑬𝑿𝑼𝑺 𝑴𝑫",
          thumbnailUrl: "https://files.catbox.moe/tiycfs.jpg",
          sourceUrl: '',
          mediaType: 1,
          renderLargerThumbnail: true
          }}
